...
func TestInfinityWebappAlias(t *testing.T) {
	...
	client.On("GetJSON", mock.Anything, "configuration/v1/webapp_alias/123/", mock.Anything).Return(nil).Run(func(args mock.Arguments) {
		webapp_alias := args.Get(2).(*config.WebappAlias)
