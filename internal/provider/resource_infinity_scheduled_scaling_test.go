		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("pexip_infinity_scheduled_scaling.test", "time_from", "08:30"),
					resource.TestCheckResourceAttr("pexip_infinity_scheduled_scaling.test", "time_to", "18:30"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("pexip_infinity_scheduled_scaling.test", "time_from", "09:00"),
					resource.TestCheckResourceAttr("pexip_infinity_scheduled_scaling.test", "time_to", "17:00"),
