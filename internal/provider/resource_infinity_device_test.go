		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("pexip_infinity_device.device-test", "enable_infinity_connect_sso", "true"),
					resource.TestCheckResourceAttr("pexip_infinity_device.device-test", "enable_standard_sso", "true"),
