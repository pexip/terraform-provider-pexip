...
func TestInfinityTurnServer(t *testing.T) {
	...
	client.On("GetJSON", mock.Anything, "configuration/v1/turn_server/123/", mock.Anything).Return(nil).Run(func(args mock.Arguments) {
		turnServer := args.Get(2).(*config.TURNServer)
