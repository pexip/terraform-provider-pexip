		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("pexip_infinity_identity_provider.identity_provider-test", "uuid"),
					...
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "idp_type", "saml"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "sso_url", "https://example.com/sso"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "idp_entity_id", "https://example.com/entity"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "service_entity_id", "https://pexip.example.com/entity"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "signature_algorithm", "http://www.w3.org/2001/04/xmldsig-more#rsa-sha256"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "digest_algorithm", "http://www.w3.org/2001/04/xmlenc#sha256"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "display_name_attribute_name", "displayName"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "registration_alias_attribute_name", "email"),
					resource.TestCheckResourceAttrSet("pexip_infinity_identity_provider.identity_provider-test", "assertion_consumer_service_url"),
					...
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "oidc_flow", "code"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "oidc_token_endpoint_auth_scheme", "client_secret_basic"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "oidc_token_signature_scheme", "rs256"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "oidc_france_connect_required_eidas_level", "eidas1"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("pexip_infinity_identity_provider.identity_provider-test", "id"),
					resource.TestCheckResourceAttrSet("pexip_infinity_identity_provider.identity_provider-test", "resource_id"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "name", "identity_provider-test-updated"),
					...
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "sso_url", "https://updated.example.com/sso"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "idp_entity_id", "https://updated.example.com/entity"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "service_entity_id", "https://pexip-updated.example.com/entity"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "signature_algorithm", "http://www.w3.org/2000/09/xmldsig#rsa-sha1"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "digest_algorithm", "http://www.w3.org/2001/04/xmlenc#sha1"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "display_name_attribute_name", "name"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "registration_alias_attribute_name", "username"),
					...
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "oidc_flow", "implicit"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "oidc_client_id", "updated-client-id"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "oidc_client_secret", "updated-client-secret"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "oidc_token_url", "https://updated.example.com/token"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "oidc_user_info_url", "https://updated.example.com/userinfo"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "oidc_jwks_url", "https://updated.example.com/jwks"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "oidc_token_endpoint_auth_scheme", "client_secret_post"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "oidc_token_signature_scheme", "hs256"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "oidc_display_name_claim_name", "name"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "oidc_registration_alias_claim_name", "preferred_username"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "oidc_additional_scopes", "profile email"),
					resource.TestCheckResourceAttr("pexip_infinity_identity_provider.identity_provider-test", "oidc_france_connect_required_eidas_level", "eidas2"),
				),
			},
		},
	})
