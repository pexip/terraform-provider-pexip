		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("pexip_infinity_break_in_allow_list_address.break_in_allow_list_address-test", "allowlist_entry_type", "temporary"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("pexip_infinity_break_in_allow_list_address.break_in_allow_list_address-test", "allowlist_entry_type", "permanent"),
